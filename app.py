...
def addroutinepage():
    if request.method == "POST":
        ...
        medication_morning = request.form.get("medication_morning", "")
        lunch = request.form.get("lunch", "")
        medication_afternoon = request.form.get("medication_afternoon", "")
        dinner = request.form.get("dinner", "")
        medication_evening = request.form.get("medication_evening", "")
        ...
        data = {
            "wake_up": wake_up,
            "breakfast": breakfast,
            "medication_morning": medication_morning,
            "lunch": lunch,
            "medication_afternoon": medication_afternoon,
            "dinner": dinner,
            "medication_evening": medication_evening,
            "bedtime": bedtime,
        }
        ...
        return render_template("addlocation.html", message="Routine added successfully!")
